...
@Api(name = "studentendpoint", namespace = @ApiNamespace(ownerDomain = "ounl.org", ownerName = "ounl.org", packagePath="lifelonglearninghub.db"))
public class StudentEndpoint {
  ...
  private boolean containsStudent(Student student) {
    ...
    try {
      mgr.getObjectById(Student.class, student.getId());
