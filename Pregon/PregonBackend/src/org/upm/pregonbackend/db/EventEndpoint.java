...
import org.upm.pregonbackend.PMF;
...
@Api(name = "eventendpoint", namespace = @ApiNamespace(ownerDomain = "upm.org", ownerName = "upm.org", packagePath="pregonbackend.db"))
public class EventEndpoint {
  ...
  public CollectionResponse<Event> listEvent(
    ...
    return CollectionResponse.<Event>builder()
      .setItems(execute)
