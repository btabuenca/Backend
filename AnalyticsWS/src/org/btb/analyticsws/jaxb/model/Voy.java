...
public class Voy {
	...
	private String Seq_voyage; //	Varchar2
	private String Age; //	Varchar2
	private String Cvoy; //	Varchar2
	private String Seq_section; //	Varchar2
	private String Lib_voyage; //	Varchar2
	private Date Datp_dep_plan; //	Date
	private int Duree = -1; //	Number
	private int Dist_tot = -1; //	Number
	private int Dist_vide = -1; //	Number
	private String Desc_voy; //	Varchar2
	private String Groupe_voy; //	Varchar2
	private String Cc_metier; //	Varchar2
	private int Dist_tot_reel = -1; //	Number
	private String Etat_voy_mtrack; //	Varchar2
	private String Cod_terminal; //	Varchar2
	private Date Hora_carga; //	Date
	private String Actualizado; //	Varchar2
	private String Seq_ress_chauf; //	Varchar2
	private String Lib_ress_chauf; //	Varchar2
	private String Seq_ress_st; //	Varchar2
	private String Lib_ress_st; //	Varchar2
	private Date Fecha_actualizacion; //	Date
	private Date Fecha_creacion; //	Date
	private Date Fecha_modificacion; //	Date
	private String Incidencias_viaje; //	Varchar2
	private String Typ_parcours; //	Varchar2
	private String Cod_agencia; //	Varchar2
	private String Seq_voy_lie; //	Varchar2

	
	public Voy() {
	}
	
	public Voy(String seq_voyage, String age, String cvoy, String seq_section, String lib_voyage, Date datp_dep_plan,
